...
class User(db.Model, UserMixin):
    ...
    reset_password_token = db.Column(db.String(1024), nullable=False, server_default='')
...
class Role(db.Model):
    ...
    name = db.Column(db.String(50), nullable=True, unique=True)  # for @roles_accepted()
    label = db.Column(db.Unicode(255), nullable=False, server_default=u'')  # for display purposes
